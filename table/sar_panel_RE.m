...
% rho,teta
xpx(nvar+1,nvar+2) = -trace(WB);  % Changed by J.P. Elhorst on 11/4/2012 (1/sige)* was missing
xpx(nvar+2,nvar+1) = xpx(nvar+1,nvar+2);
% rho,sige
xpx(nvar+1,nvar+3) = (T/sige)*trace(WB);  
xpx(nvar+3,nvar+1) = xpx(nvar+1,nvar+3);
% teta,teta
xpx(nvar+2,nvar+2) = N*(1+1/teta^2);       % Changed by J.P. Elhorst on 11/4/2012, was N*(1+1/teta^2)
% teta,sige
xpx(nvar+2,nvar+3) = -N/sige;         % Changed by J.P. Elhorst on 11/4/2012, was -N/sige
